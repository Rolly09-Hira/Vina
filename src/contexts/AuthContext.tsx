...
interface AuthContextType {
  ...
  updateUser: (updatedUser: User) => void; // NOUVELLE MÉTHODE
}
...
export const AuthProvider: FC<AuthProviderProps> = ({ children }) => {
  ...
  // NOUVELLE MÉTHODE POUR METTRE À JOUR L'UTILISATEUR DANS LE CONTEXTE
  ...
  return (
    <AuthContext.Provider
      value={{
        ...
        checkAuth,
        updateUser // AJOUTER LA NOUVELLE MÉTHODE
      }}
    >
      {children}
    </AuthContext.Provider>
