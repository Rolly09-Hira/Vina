                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border py-2 z-50">
                    ...
                    <div className="max-h-96 overflow-y-auto">
                      {donsEnAttente > 0 ? (
                        <Link
                          ...
                          className="flex items-start gap-3 px-4 py-3 hover:bg-gray-50 transition-colors border-b last:border-0"
                        >
                          ...
                          <div className="flex-1">
                            <p className="text-sm font-medium text-gray-900">
                              {donsEnAttente} nouvelle(s) intention(s) de don
                            </p>
                            <p className="text-xs text-gray-500 mt-1">
                              Des personnes souhaitent soutenir VINA
                            </p>
                            <p className="text-xs text-bleu-terre mt-1">
                              Cliquez pour voir
                            </p>
                          </div>
                        </Link>
                    ...
                    <div className="border-t px-4 py-2">
                      <Link
                        to="/admin/dons"
                        onClick={() => setShowNotifications(false)}
                        className="text-sm text-bleu-terre hover:underline block text-center"
                      >
